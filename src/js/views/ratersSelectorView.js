...
class RatersSelectorView extends View {
  _data;

  setParentEl() {
    this._parentEl = document.querySelector(`.raters_panel`);
  }
  ...
  _generateMarkup() {
    ...
    <div class="btn__div">
      ...
      <a class="btn btn__left" href="#">RATER</a>
    </div>`;
  }
...
export default new RatersSelectorView();
